...
function SearchBox() {
  ...
  return (
    ...
    className='flex border border-gray-200 rounded-full shadow-lg px-3 py-3 sm:py-1 ml-4 md:ml-20 mr-5 flex-grow max-w-3xl items-center'>
      <input type="text" value={term} onChange={(e) => setTerm(e.target.value)} className='w-full focus:outline-none ml-2 mr-2'/>

      <FaXmark onClick={() => setTerm("")} className='text-2xl cursor-pointer mr-4 sm:mr-3'/>
